package com.explead.seasons.summer.summer_views.cubes;
...
public class CubeView extends RelativeLayout implements SummerCell.OnCellViewListener {
    ...
    public void onSetInRoute(int angle, Cell.ColorCube color, boolean state) {
        ...
        routeView.setLayoutParams(new RelativeLayout.LayoutParams(LayoutParams.MATCH_PARENT,LayoutParams.MATCH_PARENT));
