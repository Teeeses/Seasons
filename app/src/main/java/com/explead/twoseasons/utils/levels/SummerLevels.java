...
public class SummerLevels {
    ...
    public SummerLevels() {
        ...
        containerCells.add(new ContainerCells(new StartCell(1, 3), new EndCell(7, 0)));
        ...
        containerCells.add(new ContainerCells(new StartCell(1, 6), new EndCell(4, 2)));
        containerCells.add(new ContainerCells(new StartCell(0, 3), new EndCell(6, 5)));
        containerCells.add(new ContainerCells(new StartCell(4, 6), new EndCell(7, 0)));
        containerCells.add(new ContainerCells(new StartCell(6, 1), new EndCell(6, 6)));
        levels.add(new LevelContainer(mass, containerCells));
        ...
        containerCells = new ArrayList<>();
        containerCells.add(new ContainerCells(new StartCell(0, 0), new EndCell(5, 6)));
        containerCells.add(new ContainerCells(new StartCell(1, 6), new EndCell(6, 1)));
        containerCells.add(new ContainerCells(new StartCell(2, 1), new EndCell(7, 7)));
        containerCells.add(new ContainerCells(new StartCell(2, 2), new EndCell(3, 7)));
        containerCells.add(new ContainerCells(new StartCell(5, 1), new EndCell(7, 3)));
        levels.add(new LevelContainer(mass, containerCells));
        ...
        containerCells = new ArrayList<>();
        containerCells.add(new ContainerCells(new StartCell(1, 1), new EndCell(8, 8)));
        containerCells.add(new ContainerCells(new StartCell(0, 5), new EndCell(7, 3)));
        containerCells.add(new ContainerCells(new StartCell(8, 0), new EndCell(1, 7)));
        containerCells.add(new ContainerCells(new StartCell(4, 3), new EndCell(8, 6)));
        containerCells.add(new ContainerCells(new StartCell(8, 5), new EndCell(8, 7)));
        levels.add(new LevelContainer(mass, containerCells));
        ...
        containerCells = new ArrayList<>();
        containerCells.add(new ContainerCells(new StartCell(0, 0), new EndCell(6, 0)));
        containerCells.add(new ContainerCells(new StartCell(1, 0), new EndCell(1, 5)));
        containerCells.add(new ContainerCells(new StartCell(3, 1), new EndCell(3, 6)));
        containerCells.add(new ContainerCells(new StartCell(5, 0), new EndCell(5, 5)));
        levels.add(new LevelContainer(mass, containerCells));
        ...
        containerCells = new ArrayList<>();
        containerCells.add(new ContainerCells(new StartCell(1, 1), new EndCell(1, 5)));
        containerCells.add(new ContainerCells(new StartCell(6, 0), new EndCell(2, 4)));
        containerCells.add(new ContainerCells(new StartCell(3, 3), new EndCell(2, 6)));
        containerCells.add(new ContainerCells(new StartCell(5, 0), new EndCell(5, 5)));
        levels.add(new LevelContainer(mass, containerCells));
        ...
        containerCells = new ArrayList<>();
        containerCells.add(new ContainerCells(new StartCell(2, 1), new EndCell(4, 7)));
        containerCells.add(new ContainerCells(new StartCell(4, 1), new EndCell(6, 7)));
        containerCells.add(new ContainerCells(new StartCell(6, 1), new EndCell(2, 7)));
        containerCells.add(new ContainerCells(new StartCell(2, 4), new EndCell(6, 4)));
        containerCells.add(new ContainerCells(new StartCell(4, 4), new EndCell(8, 4)));
        levels.add(new LevelContainer(mass, containerCells));
        ...
        containerCells = new ArrayList<>();
        containerCells.add(new ContainerCells(new StartCell(1, 1), new EndCell(1, 7)));
        containerCells.add(new ContainerCells(new StartCell(3, 0), new EndCell(3, 6)));
        containerCells.add(new ContainerCells(new StartCell(3, 2), new EndCell(3, 4)));
        containerCells.add(new ContainerCells(new StartCell(7, 0), new EndCell(0, 7)));
        containerCells.add(new ContainerCells(new StartCell(4, 0), new EndCell(4, 6)));
        levels.add(new LevelContainer(mass, containerCells));
        ...
        containerCells.add(new ContainerCells(new StartCell(2, 2), new EndCell(2, 5)));
        containerCells.add(new ContainerCells(new StartCell(0, 4), new EndCell(4, 4)));
        levels.add(new LevelContainer(mass, containerCells));
        ...
        containerCells = new ArrayList<>();
        containerCells.add(new ContainerCells(new StartCell(3, 2), new EndCell(5, 2)));
        containerCells.add(new ContainerCells(new StartCell(4, 1), new EndCell(4, 7)));
        containerCells.add(new ContainerCells(new StartCell(1, 4), new EndCell(7, 5)));
        containerCells.add(new ContainerCells(new StartCell(1, 5), new EndCell(7, 4)));
        containerCells.add(new ContainerCells(new StartCell(1, 6), new EndCell(7, 6)));
        levels.add(new LevelContainer(mass, containerCells));
